...
class AppDrawer extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // **THE FIX: A user is considered logged in if they are authenticated OR a guest.**
    final bool isLoggedIn = authState.status == AuthStatus.authenticated || authState.status == AuthStatus.guest;
    ...
    return Drawer(
      ...
      child: ListView(
        ...
        children: [
          ...
          // Conditionally show Login or Logout based on the corrected logic.
          if (isLoggedIn)
            ListTile(
