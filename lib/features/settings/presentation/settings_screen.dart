...
import 'package:visualit/core/providers/firestore_provider.dart'; // <-- Fixed import
                    ...
                    if (userData != null) {
                      return Column(
                        ...
                        children: [
                          ListTile(
                            leading: Icon(
                              userData.isPremium ? Icons.star : Icons.star_border,
                              color: userData.isPremium ? Colors.amber : Colors.grey,
                            ),
                            title: Text(
                              userData.isPremium ? 'Premium Member' : 'Free Member',
                              style: const TextStyle(fontWeight: FontWeight.bold),
                            ),
                            subtitle: Text('Credits: ${userData.credits}'),
                                ...
                                onPressed: () async {
                                  ...
                                  if (authState.status == AuthStatus.authenticated) {
                                    await ref
                                        ...
                                        .updateUserPremiumStatus(authState.user!.uid, true);
                                  }
                                },
                                child: const Text('Become Premium'),
                              ),
                            ),
                        ],
                      );
