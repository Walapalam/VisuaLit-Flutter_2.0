// lib/features/auth/presentation/auth_controller.dart
      ...
      import 'package:visualit/core/providers/firestore_provider.dart';
      ...
      class AuthController extends StateNotifier<AuthState> {
        ...
        Future<void> signUp(String name, String email, String password) async {
          ...
          try {
            ...
            log('[AuthController] signUp() success, proceeding to Firestore user creation');
            if (userCredential.user != null) {
              ...
              await _ref.read(firestoreServiceProvider).setUser(newUser);
            }
            ...
            log('[AuthContaroller] signUp() failed: $e');
            state = state.copyWith(
              status: AuthStatus.unauthenticated,
